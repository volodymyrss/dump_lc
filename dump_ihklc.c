...
dataspec dataspecs[]={
            ...
            {.name="SPI_GEDRATE1", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L1"},
            {.name="SPI_GEDRATE2", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L2"},
            {.name="SPI_GEDRATE3", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L3"},
            {.name="SPI_GEDRATE4", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L4"},
            {.name="SPI_GEDRATE5", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L5"},
            {.name="SPI_GEDRATE6", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L6"},
            {.name="SPI_GEDRATE7", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L7"},
            {.name="SPI_GEDRATE8", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L8"},
            {.name="SPI_GEDRATE9", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L9"},
            {.name="SPI_GEDRATE10",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L10"},
            {.name="SPI_GEDRATE11",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L11"},
            {.name="SPI_GEDRATE12",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L12"},
            {.name="SPI_GEDRATE13",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L13"},
            {.name="SPI_GEDRATE14",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L14"},
            {.name="SPI_GEDRATE15",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L15"},
            {.name="SPI_GEDRATE16",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L16"},
            {.name="SPI_GEDRATE17",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L17"},
            {.name="SPI_GEDRATE18",.hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTT__L18"},
            {.name="SPI_GEDSAT0",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L0"},
            {.name="SPI_GEDSAT1",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L1"},
            {.name="SPI_GEDSAT2",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L2"},
            {.name="SPI_GEDSAT3",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L3"},
            {.name="SPI_GEDSAT4",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L4"},
            {.name="SPI_GEDSAT5",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L5"},
            {.name="SPI_GEDSAT6",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L6"},
            {.name="SPI_GEDSAT7",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L7"},
            {.name="SPI_GEDSAT8",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L8"},
            {.name="SPI_GEDSAT9",  .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L9"},
            {.name="SPI_GEDSAT10", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L10"},
            {.name="SPI_GEDSAT11", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L11"},
            {.name="SPI_GEDSAT12", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L12"},
            {.name="SPI_GEDSAT13", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L13"},
            {.name="SPI_GEDSAT14", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L14"},
            {.name="SPI_GEDSAT15", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L15"},
            {.name="SPI_GEDSAT16", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L16"},
            {.name="SPI_GEDSAT17", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L17"},
            {.name="SPI_GEDSAT18", .hrw="SPI.-SCHK-HRW",.cnv="SPI.-SCHK-CNV",.col="P__DF__CAFTS__L18"},
